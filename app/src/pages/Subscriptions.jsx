...
const s = {
  ...
  modal: { backgroundColor: 'var(--card-bg)', borderRadius: '16px', width: '90%', maxWidth: '560px', maxHeight: '80vh', overflow: 'auto', boxShadow: '0 20px 60px rgba(0,0,0,0.25)', position: 'relative' },
